...
public class Armadura {
    ...
    private int consola, sintetizador, nivelSalud, energia;
    float bateria;
    ...
    public Armadura() {
        ...
        this.consola = 100000;
        this.sintetizador = 100000;
        this.nivelSalud = 100000;
        this.energia = 100000;
        this.bateria = Float.MAX_VALUE;
        this.reactor1 = 1000;
        this.reactor2 = 2389000;
    }

    public Armadura(int botaDerecha, int botaIzquierda, int guanteDerecho, int guanteIzquierdo, int consola, int sintetizador, int nivelSalud, int energia, float bateria, double reactor1, double reactor2) {
    ...
    public String toString() {
        return "Armadura{" + "botaDerecha=" + botaDerecha + ", botaIzquierda=" + botaIzquierda + ", guanteDerecho=" + guanteDerecho + ", guanteIzquierdo=" + guanteIzquierdo + ", consola=" + consola + ", sintetizador=" + sintetizador + ", nivelSalud=" + nivelSalud + ", energia=" + energia + ", bateria=" + bateria + ", reactor1=" + reactor1 + ", reactor2=" + reactor2 + ", botaDerechaOk=" + botaDerechaOk + ", guanteDerechoOk=" + guanteDerechoOk + ", botaIzquierdaOk=" + botaIzquierdaOk + ", guanteIzquierdoOk=" + guanteIzquierdoOk + ", consolaOk=" + consolaOk + ", sintetizadorOk=" + sintetizadorOk + ", nivelSaludOk=" + nivelSaludOk + ", energiaOk=" + energiaOk + '}';
    }
